  ...
  },
  {
    ...
    translations: {
      ...
      bio: {
        ...
        de: "Für mich ist Yoga eine ganzheitliche Art, mit uns selbst und mit dem Leben umzugehen — eine Praxis der Präsenz, des Bewusstseins, der Disziplin und des Mitgefühls. Auf eine stille, aber tiefgreifende Weise hat er mich in eine tiefere Beziehung zu mir selbst eingeladen und bietet weiterhin einen Raum für Neugier, Reflexion und Wachstum.\n\nMein Weg zum Yoga begann vor Jahren in Zagreb, als in der Nähe meines zeitgenössischen Tanzstudios ein Yoga-Studio eröffnete. Neugierig, eine andere Art des Bewegens und des Erlebens des Körpers zu erkunden, besuchte ich meine erste Yogastunde — und bin eigentlich nie wieder gegangen. Ich erforsche weiterhin verschiedene Yoga-Traditionen neben somatischen und Körper-Geist-Ansätzen, wobei jeder mein Verständnis von Bewegung und Verkörperung vertieft.\n\nMeine erste Yogalehrerausbildung war in Hatha und Vinyasa Yoga, 2019 in Rishikesh, Indien. Im darauffolgenden Jahr absolvierte ich eine Yin Yoga Lehrerausbildung bei Atmajyoti Yoga in Stockholm. Außerdem habe ich mich durch das Warrior Yoga Network in traumasensitivem Yoga ausgebildet, wo ich in Schweden ehrenamtlich tätig war und Menschen durch zugängliches und inklusives Yoga unterstützte. Mein Unterricht wird durch diese Erfahrungen geprägt, zusammen mit meinem Hintergrund im zeitgenössischen Tanz und Einflüssen aus Body-Mind Centering®, der Alexander-Technik, der Klein Technique und Feldenkrais. In jüngster Zeit habe ich meine Praxis durch das Studium des Klangs vertieft — mit tibetischen und kristallinen Klangschalen.\n\nIn meinen Kursen bemühe ich mich, einen einladenden Raum zu schaffen, in dem sich die Menschen dazu eingeladen fühlen, nach innen zu lauschen, bewusst zu atmen, zu lernen, zu erkunden, zu spielen. Ich glaube, dass jede Stunde eine gemeinsame Erkundung ist, bei der wir entdecken, was sich für uns unterstützend und authentisch anfühlt, während wir die Weisheit und die Traditionen ehren, aus denen Yoga kommt und die er in sich trägt. Letztendlich sehe ich Yoga als eine Praxis der Kultivierung einer neugierigen und mitfühlenden Beziehung zu uns selbst — und dadurch zu anderen — einen Atemzug, eine Bewegung nach der anderen.",
        it: "Per me, lo yoga è un modo olistico di relazionarsi con se stessi e con la vita — una pratica di presenza, consapevolezza, disciplina e compassione. In modo silenzioso ma profondo, mi ha invitata in un rapporto più intimo con me stessa e continua a offrire uno spazio per la curiosità, la riflessione e la crescita.\n\nIl mio percorso nello yoga è iniziato anni fa a Zagabria, quando uno studio yoga ha aperto vicino al mio studio di danza contemporanea. Curiosa di esplorare un altro modo di muovermi e sperimentare il corpo, sono entrata nella mia prima lezione di yoga — e non me ne sono mai davvero andata. Continuo a esplorare diverse tradizioni yoga accanto ad approcci somatici e mente-corpo, lasciando che ognuno approfondisca la mia comprensione del movimento e dell'incarnazione.\n\nLa mia prima formazione come insegnante di yoga è stata in Hatha e Vinyasa yoga, nel 2019 a Rishikesh, in India. L'anno successivo ho svolto una formazione per insegnanti di Yin Yoga con Atmajyoti Yoga a Stoccolma. Mi sono anche formata nello yoga trauma-informato attraverso il Warrior Yoga Network, dove ho fatto volontariato in Svezia, supportando le persone attraverso uno yoga accessibile e inclusivo. Il mio insegnamento è plasmato da queste esperienze, insieme alla mia formazione nella danza contemporanea e alle influenze del Body-Mind Centering®, della Tecnica Alexander, della Klein Technique e del Feldenkrais. Più di recente, ho approfondito la mia pratica attraverso lo studio del suono, lavorando con campane tibetane e di cristallo.\n\nNelle mie lezioni, cerco di creare uno spazio accogliente in cui le persone si sentano invitate ad ascoltare verso l'interno, respirare con consapevolezza, imparare, esplorare, giocare. Credo che ogni lezione sia un'esplorazione condivisa, in cui scopriamo ciò che sembra di supporto e autentico per noi stessi, onorando al contempo la saggezza e le tradizioni da cui lo yoga proviene e che porta con sé. In definitiva, vedo lo yoga come una pratica di coltivare una relazione curiosa e compassionevole con noi stessi — e, attraverso di essa, con gli altri — un respiro, un movimento alla volta.",
      },
      philosophy: {
        ...
        de: "Letztendlich sehe ich Yoga als eine Praxis der Kultivierung einer neugierigen und mitfühlenden Beziehung zu uns selbst — und dadurch zu anderen — einen Atemzug, eine Bewegung nach der anderen.",
        it: "In definitiva, vedo lo yoga come una pratica di coltivare una relazione curiosa e compassionevole con noi stessi — e, attraverso di essa, con gli altri — un respiro, un movimento alla volta.",
      },
    },
  },
  {
      ...
      {isExpanded ? (
        ...
        <div className="flex justify-end">
          <button
            ...
            className="bg-gradient-to-r from-[#B69724] to-[#D4B95C] text-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2 group relative cursor-pointer animate-in fade-in zoom-in-75 duration-300"
            style={{
  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-8 right-4 md:right-8 z-40 bg-gradient-to-r from-[#B69724] to-[#D4B95C] text-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2 group"
      >
        <Theater className="w-4 h-4 flex-shrink-0 group-hover:rotate-12 transition-transform duration-300" />
        {/* Fixed-width text area matching the upcoming-event bubble so both
            bubbles keep identical dimensions across languages and devices. */}
        <span className="block w-24 text-center truncate text-xs font-light tracking-wide">{t("venueRental")}</span>
      </button>
